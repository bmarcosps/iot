...
#define TOPICO_SUBSCRIBE "dcc091Envia5"     //tópico MQTT de escuta
#define TOPICO_PUBLISH   "dcc091Recebe5"    //tópico MQTT de envio de informações para Broker
...
#define ID_MQTT  "iotGrupo5"     //id mqtt (para identificação de sessão)
